                    ...
                    <ul className="space-y-2">
                        {item.selectedOptions.map((option, idx) => (
                            <li key={idx} className="flex items-start">
                                ...
                                <div className="flex">
                                    <div className="text-white  text-left  text-sm kanit-light">{option.optionTitle}:</div>
                                    <div className="text-gray-300 text-left text-sm ml-2 kanit-light">{option.label}</div>
                                </div>
                            </li>
                        ))}
                    </ul>
